# KC Krupp Capital — Crypto Quant Terminal

Vercel-deployed scaffold for **crypto-quant-terminal.vercel.app**, branded with the KC **flow** favicon variant from the [Krupp Capital favicon pack](/Users/maximiliankrupp/Desktop/kc-favicon-pack).
...
```bash
npm run kc:deploy   # runs deploy.py --sites=crypto-quant-terminal (idempotent)
```
